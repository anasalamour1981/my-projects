...
class Transaction(models.Model):
    ...
    name = fields.Char(string='Internal Number', default='#')
    ...
    type = fields.Selection(string='Internal Type', selection=[
    ...
    from_id = fields.Many2one('cm.entity', string='Internal From')
    ...
    def create(self, vals):
        seq = self.env['ir.sequence'].get('cm.transaction.internal')
        vals['name'] = seq
